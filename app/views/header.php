...
.search{float: right;}
.catssearch{border: 1px solid #DDDDDD;font-size: 16px; margin-bottom: 5px; padding: 5px;width: 228px;cursor: pointer;
}
...
.widget h2 ul{margin: 0;padding: 0;list-style: none;}
.widget ul li{}
.widget ul li a { background: none repeat scroll 0 0 #3399FF;color: #FFFFFF; display: block;margin-bottom: 1px;padding: 5px;text-decoration: none;
}
.widget ul li a:hover{background: #61C7FE;}
