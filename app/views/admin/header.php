...
#postinput{border:1px solid #ddd;margin-bottom:5px;padding:5px;width:490px;font-size:16px}
.cat {border:1px solid #ddd;margin-bottom:5px;padding:5px;width:300px;font-size:16px;cursor: pointer;}
input[type="submit"]{cursor: pointer}



.adminleft{width: 200px;float: left;border-right: 1px solid #ddd;margin-right: 20px;padding-right: 10px;}
.widget{margin-bottom: 20px;}
.widget h3{marging:0;background: #3399FF;color: #000;text-shadow: 0 1px 1px 1px;padding:5px;margin-bottom: 2px;border-bottom: 2px solid #EAFBFF;}
...
.widget ul li a:hover{background: #8A8A8A;color: #fff;}
.adminright{width: 572px;float: right;padding: 4px 5px;background: #fafafa;}
.adminright h2{margin: 0;margin-bottom: 10px;border-bottom: 2px dashed #000;padding-bottom: 10px;color: #666;}
